...
class OrderController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        return view('market.admin.order.index', compact('countOrders', 'paginator'));
    }
    ...
    public function save(AdminOrderSaveRequest $request, $id)
    {
        ...
        if ($result) {
            return redirect()
                ->route('market.admin.orders.edit', $id)
    ...
    public function forcedestroy($id)
    {
        ...
        if ($result) {
            return redirect()
                ->route('market.admin.orders.index', $id)
    ...
    public function edit($id)
    {
        ...
        return view('market.admin.order.edit', compact('order', 'item', 'order_products'));
    }
    ...
    public function destroy($id)
    {
        ...
        if ($st) {
            ...
            if ($result) {
                return redirect()
                    ->route('market.admin.orders.index')
