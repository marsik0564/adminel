...
class CurrencyController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        return view('market.admin.currency.index', compact('currencies'));
    }
    ...
    public function create()
    {
        ...
        return view('market.admin.currency.create');
    }
    ...
    public function store(AdminCurrencyRequest $request)
    {
        ...
        if (!empty($save)) {
            return redirect()
                ->route('market.admin.currencies.index')
    ...
    public function edit($id)
    {
        ...
        return view('market.admin.currency.edit', compact('currency'));
    }
    ...
    public function update(AdminCurrencyRequest $request, $id)
    {
        ...
        if (!empty($result)) {
            return redirect()
                ->route('market.admin.currencies.edit', $id)
                ->with(['success' => "Успешно сохранено"]);
        } else {
            return back()
                ->withErrors(['msg' => 'Ошибка сохранения']);
