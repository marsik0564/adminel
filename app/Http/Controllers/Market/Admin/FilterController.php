...
use MetaTag;
use App\Http\Requests\marketGroupFilterRequest;
use App\Http\Requests\marketValueFilterRequest;
...
class FilterController extends AdminBaseController
{
    ...
    */
    public function groupFilter()
    {
        ...
        return view('market.admin.filter.group-filter', compact('filter_groups'));
    }
    ...
    public function valueFilter()
    {
        ...
        return view('market.admin.filter.value-filter', compact('values', 'count'));
    }
    ...
    */
    ...
    public function groupFilterAdd(marketGroupFilterRequest $request)
    {
        ...
        if ($request->isMethod('get')) {
            ...
            return view('market.admin.filter.group-filter-add');
        }
    }
    ...
    */
    ...
    public function groupFilterEdit(marketGroupFilterRequest $request, $id)
    {
        if ($request->isMethod('post')) {
        ...
        if ($request->isMethod('get')) {
            ...
            return view('market.admin.filter.group-filter-edit', compact('group'));
        }
    }
    ...
    */
    ...
    public function valueFilterAdd(marketValueFilterRequest $request)
    {
        if ($request->isMethod('post')) {
        ...
        if ($request->isMethod('get')) {
            ...
            return view('market.admin.filter.value-filter-add', compact('group'));
        }
    }
    ...
    */
    ...
    public function valueFilterEdit(marketValueFilterRequest $request, $id)
    {
        if ($request->isMethod('post')) {
        ...
        if ($request->isMethod('get')) {
            ...
            return view('market.admin.filter.value-filter-edit', compact('value', 'group'));
        }
    }
