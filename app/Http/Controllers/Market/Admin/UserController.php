...
class UserController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        return view('market.admin.user.index', compact('countUsers', 'paginator'));
    }
    ...
    public function create()
    {
        ...
        return view('market.admin.user.create');
    }
    ...
    public function store(AdminUserCreateRequest $request)
    {
        ...
        if (!empty($user)) {
            ...
            if (!empty($role)) {
            return redirect()
                ->route('market.admin.users.index')
    ...
    public function edit($id)
    {
        ...
        return view('market.admin.user.edit', compact('orders', 'role', 'count',  'item'));
    }
    ...
    public function update(AdminUserEditRequest $request, User $user, UserRole $role )
    {
        ...
        if (!empty($save)) {
            ...
            return redirect()
                ->route('market.admin.users.edit', $user->id)
                ->with(['success' => "Успешно сохранено"]);
        } else {
            return back()
                ->withErrors(['msg' => 'Ошибка сохранения'])
