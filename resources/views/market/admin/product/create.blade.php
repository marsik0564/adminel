...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form action="{{ route('market.admin.products.store') }}" 
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    @include('market.admin.product.include.image_single_create')
                                </div>
                                <div class="col-md-8">
                                    @include('market.admin.product.include.image_gallery_create')
                                </div>
                            </div>
