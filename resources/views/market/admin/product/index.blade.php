                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tr style="
                                    ...
                                    <td class="text-center">
                                        ...
                                        href="{{ route('market.admin.products.returnstatus', $product->id) }}" 
                                        >
                                            <i class="fa fa-fw fa-refresh"></i>
                                        </a>
                                        @else
                                        <a title="Перевести статус = Off" class="ml-2"
                                        href="{{ route('market.admin.products.deletestatus', $product->id) }}" 
                                        >
                                        ...
                                        href="{{ route('market.admin.products.deleteproduct', $product->id) }}"
                                        >
